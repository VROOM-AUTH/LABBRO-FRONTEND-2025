...
export default function AttendanceCalendar({ data }) {
    ...
    return (
        <div className="flex justify-evenly h-96 items-center flex-col w-[600px] mr-2 bg-[#190C34] p-4 rounded-xl mb-4 mt-4 md:w-11/12 md:mt-4 md:mb-0 md:mr-0 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] order-1 md:order-2">
