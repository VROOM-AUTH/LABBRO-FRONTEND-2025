...
export default function UserList({ users }) {
    ...
    return (
        <div className="flex flex-col justify-start items-center bg-[#190C34] rounded-xl w-96 h-96 md:w-full md:mt-8 md:mr-0 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
