...
export default function UserStatusCard({
    ...
    return (
        <div className="flex rounded-lg justify-evenly items-center flex-col bg-[#190c34] w-96 h-fit min-h-52 m-2 md:w-11/12 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
