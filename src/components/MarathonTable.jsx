            ...
            <ul className='w-full p-4 space-y-4'>
                {data.map((entry, index) => (
                    <li
                        ...
                        className={`flex justify-between items-center p-4  cursor-pointer rounded-lg transition-transform transform hover:scale-105 hover:bg-opacity-80 shadow-md ${
                            index === 0
