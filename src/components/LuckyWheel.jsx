...
export default function LuckyWheel({ vroomvolts, setVroomvolts }) {
    ...
    return (
        <div className="w-1/4 bg-[#190C34] rounded-xl flex flex-col justify-evenly items-center h-fit shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] md:w-11/12 md:h-fit md:mt-16">
