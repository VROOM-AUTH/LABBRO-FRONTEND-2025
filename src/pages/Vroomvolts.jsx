...
export default function Vroomvolts() {
    ...
    return (
        <div className="flex justify-evenly items-center w-full h-screen relative md:flex-col md:justify-center">
            <TopNavigation />

            <div className="mt-8 absolute top-8 left-12 h-14  flex justify-start items-center bg-[#351748] py-2 px-3 rounded-3xl shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] md:top-2 md:mt-0 md:left-2">
